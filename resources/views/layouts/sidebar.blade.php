    <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark"
         ...
         <div>
             ...
             style="position: absolute; top: 10px; z-index: 10; transition: left 0.3s, right 0.3s; right: 16px;"
    ...
    <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
        ...
        <li><a class="dropdown-item" href="{{route('home')}}">{{ __('Ir al inicio de la aplicación') }}</a></li>
