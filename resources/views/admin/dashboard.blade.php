...
<div class="container-fluid py-4">
  ...
  <div class="row mb-4">
    <div class="col-12 col-md-6">
      ...
      <div class="chart">
        <div class="bar male"
             style="height: {{ round($data['maleCount'] / $maxGender * 100, 1) }}%;"
             title="Hombres: {{ $data['maleCount'] }}">
          <span>{{ $data['maleCount'] }}</span>
        </div>
        <div class="bar female"
             style="height: {{ round($data['femaleCount'] / $maxGender * 100, 1) }}%;"
    ...
    <div class="col-12 col-md-6">
      ...
      <div class="chart">
        <div class="bar minor"
             style="height: {{ round($data['minorsCount'] / $maxAge * 100, 1) }}%;"
             title="Menores: {{ $data['minorsCount'] }}">
          <span>{{ $data['minorsCount'] }}</span>
        </div>
        <div class="bar adult"
             style="height: {{ round($data['adultsCount'] / $maxAge * 100, 1) }}%;"
